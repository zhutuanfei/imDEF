function [acc,se,p,sp,g,f,fpr,auc,auc_pr]...
    = imDEF_CV(Train,Label,TestData,TestLabel,varargin)
% cross validation for optimizing parameters
para.n = 100;
para.Learner = 'tree';
if nargin < 3
    error('wrong number of paramters! The training data, training label, testing data, and testing label are required!')
end
if nargin > 4
   para.n = varargin{1};
end
if nargin > 5
   para.Learner = varargin{2};
end
